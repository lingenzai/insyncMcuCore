...
int main(void)
{
  ...
  {
    /*
      1. mcu state machine process
      2. all device(chip) state machine in this;
    */
    mcu_allStateMachine();
...
static void MX_RTC_Init(void)
{
  ...
  */
  ...
  // Now we dont enter this mode, closed the counter.
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : CCM_PIN18_RSL10_RST_Pin CCM_PIN46_VPON_Pin */
  GPIO_InitStruct.Pin = CCM_PIN18_RSL10_RST_Pin|CCM_PIN46_VPON_Pin;
  ...
  GPIO_InitStruct.Pin = CCM_PIN22_ACCEL_INT_Pin;
